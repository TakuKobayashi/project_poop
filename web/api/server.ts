...
const user = "8fbea9f2-4f47-4407-b409-c74fb3ede4ed";
const pass = "ZmyibTmbXSjD";
...
var server = http.createServer(function(request, response) {
  ...
  const url_parts = (request.method=='GET') ? url.parse(request.url,true) : false;
  ...
  if(!!request.url.match("/api") ){
    ...
    var uri = "../frontend/build/"+url.parse(request.url).pathname
